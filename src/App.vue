...
<template>
  <nav class="navbar navbar-light mb-3 shadow">
    <div class="container-fluid">
      <a role="" class="navbar-brand">Speech-To-Text
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-6 mx-auto bg-secondary pb-3" style="height: 78vh;overflow-y: scroll;">
        ...
        <ul class="list-group mt-2" data-bs-theme="light">
          <li class="list-group-item list-group-item-danger">Test, Treatment & Procedures</li>
          <li class="list-group-item">
            <div class="d-flex align-items-center justify-content-between">
              <textarea type="text" rows="1" class="form-control form-control-sm me-3 resize-none"
        ...
        <ul class="list-group mt-2" data-bs-theme="light">
          <li class="list-group-item list-group-item-success">Protected Health Information (PHI)</li>
          <li class="list-group-item">
            <div class="d-flex align-items-center justify-content-between">
              <textarea type="text" rows="1" class="form-control form-control-sm me-3 resize-none"
